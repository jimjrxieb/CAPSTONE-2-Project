...
| Risk | L (1-5) | I (1-5) | Score | Mitigation |
|---|---|---|---|---|
| Eugene cannot explain why it assigned a control | | | | Reasoning field in finding output (mapped from RAG) |
...
| Unauthorized access to Eugene API endpoint | | | | Auth on /api/eugene, network policy, rate limiting |
...
| 12-19 | B | Human decides. Eugene provides context. |
...
## Completed Example — Eugene Current Prototype
